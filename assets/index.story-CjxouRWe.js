...
`,D=s.div`
  ...
  min-width: 0;
  max-width: ${e=>e.center?a(6,80,24):p}px;
  padding: 40px ${72}px;
  margin: 0 auto;
  display: flex;
...
`,A=b.forwardRef(function({span:e,children:t},n){let{withLeft:r}=(0,y.useContext)(S);return(0,x.jsx)(j,{span:e,withLeft:r,ref:n,children:t})}),j=s.div`
...
`,N={wide:{x:40,y:40},default:{x:24,y:24},column1:{x:16,y:16},narrow:{x:24,yTop:12,yBottom:20},narrowColumn1:{x:16,yTop:4,yBottom:0}},P=s.div`
