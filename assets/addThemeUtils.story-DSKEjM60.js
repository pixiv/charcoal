import{n as e}from"./chunk-BneVvdWh.js";import{M as t,at as n,it as r,ot as i,rt as a}from"./iframe-9mJ-R8Nn.js";function o(e){return e===void 0?``:typeof e==`number`?`${e}px`:e}var s=e((()=>{}));function c(e,t,n,r){return a`
  ...
  `}function f(e){return a`
    margin-right: ${o(e)};
  `}var p=e((()=>{n(),s()}));function m(e,t,n,r){return a`
  ...
  `}function v(e){return a`
    padding-right: ${e}px;
  `}var y=e((()=>{n(),s()}));function b(e,t){return a`
    gap: ${e}px ${o(t)};
  `}function x(e){return a`
    row-gap: ${e}px;
  `}function S(e){return a`
    column-gap: ${e}px;
  `}var C=e((()=>{n(),s()})),w,T=e((()=>{n(),w=a`
  &:disabled,
...
`}));function P(e){return{...e,utils:{margin:c,marginTop:l,marginLeft:d,marginBottom:u,marginRight:f,padding:m,paddingTop:h,paddingLeft:_,paddingBottom:g,paddingRight:v,gap:b,rowGap:x,columnGap:S,typography:E,focusVisibleFocusRingCss:A,assertiveRingCss:M,disabledCss:w}}}var F=e((()=>{p(),y(),C(),T(),k(),j(),N()}));function I(e){return{...P(e),color:{...e.color,mycolor:`#ff9e8c`}}}var L=e((()=>{F()})),R,z,B,V,H,U,W,G,K,q,J,Y=e((()=>{n(),L(),R=t(),z={title:`styled/addThemeUtils`},B=()=>(0,R.jsx)(r,{theme:I,children:(0,R.jsxs)(V,{children:[(0,R.jsx)(K,{children:(0,R.jsx)(W,{children:"${({ theme }) => theme.utils.typography(14, true)}"})}),(0,R.jsx)(K,{children:(0,R.jsx)(G,{children:(0,R.jsx)(H,{children:(0,R.jsx)(U,{children:`\${({ theme }) => [
