import{n as e}from"./chunk-BneVvdWh.js";import{At as t,Dt as n,Pt as r,gt as i,kt as a,nt as o,pt as s}from"./iframe-CVQNsQPh.js";import{n as c,t as l}from"./Base-BB98uQw6.js";import{n as u,t as d}from"./styled-a89-iXFs.js";function f(){return(0,p.jsx)(l,{viewBoxSize:m,size:m,currentColor:!0,path:(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(`path`,{d:`M8 16C3.58172 16 0 12.4183 0 8C0 3.58172 3.58172 0 8 0C12.4183
...
`;try{_.displayName=`HintText`,_.__docgenInfo={description:``,displayName:`HintText`,props:{context:{defaultValue:null,description:``,name:`context`,required:!0,type:{name:`enum`,value:[{value:`"section"`},{value:`"page"`}]}},className:{defaultValue:null,description:``,name:`className`,required:!1,type:{name:`string`}}}}}catch{}})),T,E,D,O;e((()=>{w(),T=o(),E={title:`react-sandbox/HintText`,component:_,parameters:{layout:`centered`},argTypes:{children:{type:`string`},context:{control:{type:`select`,options:[`page`,`section`]}}}},D={args:{children:`HintText`,context:`section`},render:e=>(0,T.jsx)(_,{...e})},O={args:{children:`LongLongLongLongLongLongLongLongLongText`,context:`section`},render:e=>(0,T.jsx)(`div`,{style:{width:200},children:(0,T.jsx)(_,{...e})})},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  args: {
    children: 'HintText',
    context: 'section'
  },
