...
`,O=r.button`
  ...
  ${({noBackground:e=!1})=>e&&i`
      /* stylelint-disable-next-line no-duplicate-selectors */
      &:hover {
        background: transparent;
      }
    `}
`,k=r(O).attrs({type:`button`,disabled:!0})`
  && {
    color: ${({theme:e})=>e.color.text3};
    background: none;
  }
