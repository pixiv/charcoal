...
`,C=i.h2`
  margin: 0;
  color: ${h.color.text.secondary.default};
  font-size: ${h.text.fontSize.heading.xs};
  line-height: ${h.text.lineHeight.heading.xs};
`,w=i.a`
  cursor: pointer;
  font-weight: bold;
  font-size: ${h.text.fontSize.body};
  line-height: ${h.text.lineHeight.body};
  padding: 13px ${h.space.layout[30]};
  border-top: 2px transparent;

  color: ${h.color.text.tertiary.default};
  &:hover {
    color: ${h.color.text.tertiary.hover};
  }
  &:active {
    color: ${h.color.text.tertiary.press};
  }

  &[aria-selected='true'] {
    color: ${h.color.text.default};
    border-top: 2px solid ${h.color.border.selected};
    &:hover {
      color: ${h.color.text.hover};
    }
    &:active {
      color: ${h.color.text.press};
    }
  }
`,T=i.div`
  display: grid;
...
`,E=i.div`
  ...
  align-items: center;
  gap: ${h.space.layout[20]};
`,D=i.a`
  width: 40px;
  height: 40px;
  display: grid;
  place-items: center;
  border-radius: ${h.radius.oval};
  cursor: pointer;

  color: ${h.color.icon.default};
  background-color: ${h.color.container.secondary.default};
  &:hover {
    color: ${h.color.icon.hover};
    background-color: ${h.color.container.secondary.hover};
  }
  &:active {
    color: ${h.color.icon.press};
    background-color: ${h.color.container.secondary.press};
  }
`,O=i.span`
  color: ${h.color.text.default};
  font-size: ${h.text.fontSize.caption.m};
  line-height: ${h.text.lineHeight.caption.m};
  font-weight: bold;
`,k=i.a`
  grid-area: ShowAll;
  cursor: pointer;
...
`,j=i.article`
  display: grid;
  gap: ${h.space.layout[10]};
`,M=i.img`
  width: 100%;
  aspect-ratio: 3 / 2;
  border-radius: ${h.radius.m};
`,N=i.h3`
  color: ${h.color.text.default};
  font-size: ${h.text.fontSize.caption.m};
  line-height: ${h.text.lineHeight.caption.m};
...
`,P=i.p`
  margin: 0;
  color: ${h.color.text.tertiary.default};
  font-size: ${h.text.fontSize.caption.s};
  line-height: ${h.text.lineHeight.caption.s};
`}));function I(){let[e,t]=(0,L.useState)(z[0]);return(0,R.jsxs)(`section`,{className:`grid max-w-fit gap-[24px]`,children:[(0,R.jsx)(`nav`,{children:(0,R.jsx)(`div`,{"aria-label":`Categories`,role:`tablist`,children:z.map(n=>(0,R.jsx)(`a`,{className:`text-body px-component-30 border-t-l cursor-pointer border-[0px] border-solid py-[13px] font-bold ${n===e?`border-selected text-text`:`border-[transparent] text-text-tertiary hover:text-text-tertiary-hover active:text-text-tertiary-press`}`,id:`category-${n}`,role:`tab`,"aria-selected":n===e,"aria-controls":`panel-${n}`,onClick:()=>{t(n)},children:n},n))})}),(0,R.jsx)(`h2`,{className:`text-text-secondary text-heading-xs m-0`,children:`Works from users you follow`}),(0,R.jsxs)(`div`,{className:`grid [grid-template-areas:'UserInfo_._ShowAll''ArtworkList_ArtworkList_ArtworkList']`,id:`panel-${e}`,role:`tabpanel`,"aria-labelledby":`category-${e}`,children:[(0,R.jsxs)(`div`,{className:`grid grid-flow-col items-center justify-start gap-layout-20 [grid-area:UserInfo]`,children:[(0,R.jsx)(`a`,{className:`rounded-oval text-icon hover:text-icon-hover active:text-icon-press bg-container-secondary hover:bg-container-hover active:bg-container-press grid h-[40px] w-[40px] cursor-pointer place-items-center`,"aria-label":`UserIcon`,children:(0,R.jsx)(c,{name:`24/FaceEdit`})}),(0,R.jsx)(`span`,{className:`text-text text-caption-m font-bold`,children:`UserName`}),(0,R.jsx)(a,{variant:`Primary`,size:`S`,children:`Follow`})]}),(0,R.jsx)(`a`,{className:`text-text-tertiary hover:text-text-hover active:text-text-press text-caption-m cursor-pointer content-center text-right [grid-area:ShowAll]`,children:`Show all`}),(0,R.jsx)(`ul`,{className:`grid max-w-[424px] list-none grid-cols-3 gap-layout-20 p-0 [grid-area:ArtworkList]`,children:B.map(e=>(0,R.jsx)(`li`,{children:(0,R.jsxs)(`article`,{className:`grid gap-layout-10`,children:[(0,R.jsx)(`img`,{className:`rounded-m aspect-[3/2] w-[100%]`,src:e.thumbnail,alt:e.title}),(0,R.jsx)(`h3`,{className:`text-text text-caption-m m-0`,children:e.title}),(0,R.jsx)(`p`,{className:`text-text-tertiary text-caption-s m-0`,children:e.description})]})},e.id))},e)]})]})}var L,R,z,B,V=t((()=>{L=e(o(),1),n(),R=s(),z=[`Illustration`,`Comic`,`Novel`,`3D`,`Shopping`],B=Array.from({length:3},(e,t)=>({id:t,title:`Title`,thumbnail:`https://loremflickr.com/150/100/animals?random=${t}&lock=${t}`,description:`Description`}))})),H,U,W;t((()=>{F(),V(),H={title:`theme/Token v2 Demo`,component:_},U={parameters:{tokenVersion:`v2`},render:_},W={parameters:{tokenVersion:`v2`},render:I},U.parameters={...U.parameters,docs:{...U.parameters?.docs,source:{originalSource:`{
  parameters: {
    tokenVersion: 'v2'
  },
...
}`,...W.parameters?.docs?.source}}}}))();export{U as Styled,W as Tailwind,H as default};