...
`,(0,c.jsxs)(n.p,{children:[`標準 plugin には `,(0,c.jsx)(n.code,{children:`.ch-focus-ring`}),` も含まれているため、フォーカス可能な要素に付けると React 版と同等の focus ring を適用できます。`]})]})}function s(e={}){let{wrapper:n}={...t(),...e.components};return n?(0,c.jsx)(n,{...e,children:(0,c.jsx)(o,{...e})}):o(e)}var c;e((()=>{c=i(),a(),n()}))();export{s as default};