import{a as e,n as t}from"./chunk-BneVvdWh.js";import{Et as n,Ht as r,Ot as i,Q as a,Vt as o,X as s,Z as c,en as l,mt as u,zt as d}from"./iframe-y42Cim2R.js";import{n as f,t as p}from"./hooks-DRsa5BdH.js";import{n as m,t as h}from"./utils-BrnQqe39.js";import{n as g,t as _}from"./Base-BZ2IVbao.js";function v(){if(y!==void 0)return y;y=!1;try{let t=Object.defineProperty({},`passive`,{get(){return y=!0}});window.addEventListener(`test`,e,t),window.removeEventListener(`test`,e)}catch{}return y;function e(){}}var y,b,x=t((()=>{b=()=>navigator.userAgent.includes(`Edge/`)})),S,C,w=t((()=>{S=e(l(),1),C=typeof window<`u`?S.useLayoutEffect:S.useEffect}));function T({direction:e}){return(0,D.jsx)(_,{viewBoxSize:A,size:A,currentColor:!0,path:k,transform:E(e)})}function E(e){switch(e){case O.Up:return`rotate(270 12 12)`;case O.Down:return`rotate(90 12 12)`;case O.Left:return`rotate(180 12 12)`;case O.Right:return;default:return m(e)}}var D,O,k,A,j=t((()=>{h(),g(),D=u(),O=function(e){return e.Up=`up`,e.Down=`down`,e.Left=`left`,e.Right=`right`,e}({}),k=`M8.08579 16.5858C7.30474 17.3668 7.30474 18.6332 8.08579 19.4142C8.86684 20.1953 10.1332 20.1953 10.9142 19.4142L18.3284 12L10.9142 4.58579C10.1332 3.80474 8.86684 3.80474 8.08579 4.58579C7.30474 5.36684 7.30474 6.63317 8.08579 7.41421L12.6716 12L8.08579 16.5858Z`,A=24;try{T.displayName=`NextIcon`,T.__docgenInfo={description:``,displayName:`NextIcon`,filePath:`/home/runner/work/charcoal/charcoal/packages/react-sandbox/src/components/icons/NextIcon.tsx`,methods:[],props:{direction:{defaultValue:null,declarations:[{fileName:`charcoal/packages/react-sandbox/src/components/icons/NextIcon.tsx`,name:`Props`}],description:``,name:`direction`,parent:{fileName:`charcoal/packages/react-sandbox/src/components/icons/NextIcon.tsx`,name:`Props`},required:!0,tags:{},type:{name:`enum`,raw:`WedgeDirection`,value:[{value:`"up"`,description:``,fullComment:``,tags:{}},{value:`"down"`,description:``,fullComment:``,tags:{}},{value:`"left"`,description:``,fullComment:``,tags:{}},{value:`"right"`,description:``,fullComment:``,tags:{}}]}}},tags:{}}}catch{}}));function M({direction:e,show:t,offset:n=0,padding:r=0,bottomOffset:i=0,gradient:a=!1,onClick:o}){let s=e===P.Left?{left:a?n-72:n,paddingLeft:Math.max(r,0),paddingBottom:i}:{right:a?n-72:n,paddingRight:Math.max(r,0),paddingBottom:i};return(0,N.jsx)(L,{type:`button`,onClick:o,hide:!t,style:s,css:F,children:(0,N.jsx)(I,{children:(0,N.jsx)(T,{direction:e===P.Right?O.Right:e===P.Left?O.Left:m()})})})}var N,P,F,I,L,R=t((()=>{o(),h(),j(),i(),N=u(),P=function(e){return e.Right=`right`,e.Left=`left`,e}({}),F=d`
...
`,L=r.button`
  ...
  &:hover ${I} {
    background-color: ${({theme:e})=>n(e.color.surface4,e.effect.hover)};
    color: ${({theme:e})=>n(e.color.text5,e.effect.hover)};
  }

  &:active ${I} {
    background-color: ${({theme:e})=>n(e.color.surface4,e.effect.press)};
    color: ${({theme:e})=>n(e.color.text5,e.effect.press)};
  }
