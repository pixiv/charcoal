...
`]}),`
`,(0,c.jsx)(n.hr,{}),`
`,(0,c.jsx)(n.h2,{id:`react-aria-モノパッケージへの移行`,children:`React Aria モノパッケージへの移行`}),`
`,(0,c.jsxs)(n.p,{children:[`React Aria v1.17.0 (`,(0,c.jsx)(n.a,{href:`https://react-aria.adobe.com/releases/v1-17-0`,rel:`nofollow`,children:`リリースノート`}),`) に合わせ、`,(0,c.jsx)(n.code,{children:`@charcoal-ui/react`}),` の React Aria 依存を個別パッケージ（`,(0,c.jsx)(n.code,{children:`@react-aria/*`}),`, `,(0,c.jsx)(n.code,{children:`@react-stately/*`}),`）からモノパッケージ（`,(0,c.jsx)(n.code,{children:`react-aria`}),`, `,(0,c.jsx)(n.code,{children:`react-stately`}),`）に移行しました。`]}),`
`,(0,c.jsxs)(n.ul,{children:[`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`react-aria`}),` / `,(0,c.jsx)(n.code,{children:`react-stately`}),` は `,(0,c.jsx)(n.strong,{children:`dependencies から peerDependencies に変更`}),`されました（`,(0,c.jsx)(n.code,{children:`react-aria >= 3.48.0`}),`, `,(0,c.jsx)(n.code,{children:`react-stately >= 3.46.0`}),`）。npm 7+・pnpm・yarn では自動インストールされるため通常は追加対応不要です。`]}),`
`,(0,c.jsx)(n.li,{children:`目的：アプリ側でも React Aria を使う場合の重複インストールを防ぎ、バンドルサイズとランタイムの不整合を解消します。`}),`
`,(0,c.jsxs)(n.li,{children:[`既存の `,(0,c.jsx)(n.code,{children:`@react-aria/*`}),` 個別パッケージとも共存可能ですが、バージョン不整合に注意してください。`]}),`
`]}),`
`,(0,c.jsx)(n.h3,{id:`必要な対応任意`,children:`必要な対応（任意）`}),`
`,(0,c.jsxs)(n.p,{children:[(0,c.jsx)(n.code,{children:`@react-aria/*`}),` / `,(0,c.jsx)(n.code,{children:`@react-stately/*`}),` を直接 import している場合、React Aria 公式 codemod でモノパッケージ import に移行できます。`]}),`
