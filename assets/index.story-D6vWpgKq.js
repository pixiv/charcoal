...
`;try{_.displayName=`HintText`,_.__docgenInfo={description:``,displayName:`HintText`,props:{context:{defaultValue:null,description:``,name:`context`,required:!0,type:{name:`enum`,value:[{value:`"page"`},{value:`"section"`}]}},className:{defaultValue:null,description:``,name:`className`,required:!1,type:{name:`string`}}}}}catch{}})),T,E,D,O;e((()=>{w(),T=o(),E={title:`react-sandbox/HintText`,component:_,parameters:{layout:`centered`},argTypes:{children:{type:`string`},context:{control:{type:`select`,options:[`page`,`section`]}}}},D={args:{children:`HintText`,context:`section`},render:e=>(0,T.jsx)(_,{...e})},O={args:{children:`LongLongLongLongLongLongLongLongLongText`,context:`section`},render:e=>(0,T.jsx)(`div`,{style:{width:200},children:(0,T.jsx)(_,{...e})})},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  args: {
    children: 'HintText',
    context: 'section'
  },
