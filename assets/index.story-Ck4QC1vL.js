...
`,Y=r.div`
  ...
  mask: linear-gradient(to right, transparent, #000 ${72}px)
    ${e=>e.show?0:-72}px 0;
`;try{z.displayName=`Carousel`,z.__docgenInfo={description:``,displayName:`Carousel`,props:{buttonOffset:{defaultValue:{value:`0`},description:``,name:`buttonOffset`,required:!1,type:{name:`number`}},buttonPadding:{defaultValue:{value:`16`},description:``,name:`buttonPadding`,required:!1,type:{name:`number`}},bottomOffset:{defaultValue:{value:`0`},description:``,name:`bottomOffset`,required:!1,type:{name:`number`}},defaultScroll:{defaultValue:null,description:``,name:`defaultScroll`,required:!1,type:{name:`ScrollProps`}},hasGradient:{defaultValue:null,description:``,name:`hasGradient`,required:!1,type:{name:`boolean`}},onScroll:{defaultValue:null,description:``,name:`onScroll`,required:!1,type:{name:`((left: number) => void)`}},onResize:{defaultValue:null,description:``,name:`onResize`,required:!1,type:{name:`((width: number) => void)`}},centerItems:{defaultValue:null,description:``,name:`centerItems`,required:!1,type:{name:`boolean`}},onScrollStateChange:{defaultValue:null,description:``,name:`onScrollStateChange`,required:!1,type:{name:`((canScroll: boolean) => void)`}},scrollAmountCoef:{defaultValue:{value:`0.75`},description:``,name:`scrollAmountCoef`,required:!1,type:{name:`number`}},fadeInGradient:{defaultValue:null,description:``,name:`fadeInGradient`,required:!1,type:{name:`boolean`}}}}}catch{}try{H.displayName=`SCROLL_AMOUNT_COEF`,H.__docgenInfo={description:`カルーセル系のスクロール量の定数`,displayName:`SCROLL_AMOUNT_COEF`,props:{}}}catch{}})),X,Z,Q,$;t((()=>{ee(),X=d(),Z={title:`react-sandbox/Carousel`,component:z,argTypes:{}},Q=[1,2,3,4,5],$={render:e=>(0,X.jsx)(z,{...e,children:(0,X.jsx)(`div`,{style:{display:`flex`,gap:`8px`},children:Q.map(e=>(0,X.jsx)(`div`,{style:{width:`200px`,height:`100px`,backgroundColor:`var(--charcoal-brand)`,filter:`hue-rotate(0.${e}turn)`}},e))})})},$.parameters={...$.parameters,docs:{...$.parameters?.docs,source:{originalSource:`{
