...
`})),y,b,x;t((()=>{v(),y=c(),b={title:`react-sandbox/SwitchCheckbox`,component:d},x={render:e=>(0,y.jsx)(d,{...e,children:`children`})},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  render: props => {
