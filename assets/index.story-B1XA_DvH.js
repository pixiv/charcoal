...
`,L=o.button`
  ...
  &:hover ${I} {
    background-color: ${({theme:e})=>s(e.color.surface4,e.effect.hover)};
    color: ${({theme:e})=>s(e.color.text5,e.effect.hover)};
  }

  &:active ${I} {
    background-color: ${({theme:e})=>s(e.color.surface4,e.effect.press)};
    color: ${({theme:e})=>s(e.color.text5,e.effect.press)};
  }
