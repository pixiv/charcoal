...
`;LeftMenu.__docgenInfo={description:"",methods:[],displayName:"LeftMenu",props:{links:{required:!0,tsType:{name:"unknown"},description:""},active:{required:!0,tsType:{name:"ID"},description:""}}};const index_story={title:"react-sandbox/LeftMenu",component:LeftMenu},links=[{text:"text1",to:"",id:"1"},{text:"text2",to:"",id:"2"},{text:"text3",to:"",id:"3"}],Default={render:props=>(0,jsx_runtime.jsx)(LeftMenu,{...props,links,active:"1",children:"children"})};Default.parameters={...Default.parameters,docs:{...Default.parameters?.docs,source:{originalSource:'{\n  render: props => {\n    return <LeftMenu {...props} links={links} active="1">\n        children\n      </LeftMenu>;\n  }\n}',...Default.parameters?.docs?.source}}}},"./packages/react-sandbox/src/components/TextEllipsis/index.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{T:()=>TextEllipsis});var styled_components_browser_esm=__webpack_require__("./node_modules/.pnpm/styled-components@5.3.11_@babel+core@7.28.5_react-dom@18.3.1_react@18.3.1__react-is@18.3.1_react@18.3.1/node_modules/styled-components/dist/styled-components.browser.esm.js"),react=__webpack_require__("./node_modules/.pnpm/react@18.3.1/node_modules/react/index.js");const hasChildren=element=>(0,react.isValidElement)(element)&&Boolean(element.props.children),childToString=child=>null==child||"boolean"==typeof child||"{}"===JSON.stringify(child)?"":child.toString(),onlyText=children=>Array.isArray(children)||(0,react.isValidElement)(children)?react.Children.toArray(children).reduce(((text,child)=>{let newText="";return newText=(0,react.isValidElement)(child)&&hasChildren(child)?onlyText(child.props.children):(0,react.isValidElement)(child)&&!hasChildren(child)?"":childToString(child),text.concat(newText)}),""):childToString(children),TextEllipsis=styled_components_browser_esm.Ay.div.attrs((({children,title=onlyText(children)})=>({title:""!==title?title:void 0})))`
  overflow: hidden;
  ...
  ${({lineLimit=1,lineHeight})=>1===lineLimit?styled_components_browser_esm.AH`
        ...
        `}
`},"./packages/react-sandbox/src/styled.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{w:()=>theme});var styled_components__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/.pnpm/styled-components@5.3.11_@babel+core@7.28.5_react-dom@18.3.1_react@18.3.1__react-is@18.3.1_react@18.3.1/node_modules/styled-components/dist/styled-components.browser.esm.js");const theme=(0,__webpack_require__("./packages/styled/dist/index.js").an)(styled_components__WEBPACK_IMPORTED_MODULE_1__.Ay)}}]);
//# sourceMappingURL=react-sandbox-src-components-LeftMenu-index-story.e3770999.iframe.bundle.js.map