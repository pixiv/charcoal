...
`,Button=styled_components_browser_esm.Ay.button`
  ...
  &:hover ${CarouselButtonIcon} {
    background-color: ${({theme})=>(0,dist.Cf)(theme.color.surface4,theme.effect.hover)};
    color: ${({theme})=>(0,dist.Cf)(theme.color.text5,theme.effect.hover)};
  }

  &:active ${CarouselButtonIcon} {
    background-color: ${({theme})=>(0,dist.Cf)(theme.color.surface4,theme.effect.press)};
    color: ${({theme})=>(0,dist.Cf)(theme.color.text5,theme.effect.press)};
  }
...
//# sourceMappingURL=react-sandbox-src-components-Carousel-index-story.51fa8917.iframe.bundle.js.map