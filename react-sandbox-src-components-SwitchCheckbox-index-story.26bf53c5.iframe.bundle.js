  ...
  &:not(:disabled):focus {
    ~ ${SwitchInner} {
      box-shadow: 0 0 0 4px
        ${({theme})=>(0,index_esm.Cf)(theme.color.brand,theme.elementEffect.disabled)};
    }
  }
...
//# sourceMappingURL=react-sandbox-src-components-SwitchCheckbox-index-story.26bf53c5.iframe.bundle.js.map