"use strict";(self.webpackChunkcharcoal_ui=self.webpackChunkcharcoal_ui||[]).push([[9969],{"./packages/react/docs/TokenV2Demo.story.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Styled:()=>Styled,Tailwind:()=>Tailwind,default:()=>TokenV2Demo_story});var jsx_runtime=__webpack_require__("./node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),react=__webpack_require__("./node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),styled_components_browser_esm=__webpack_require__("./node_modules/.pnpm/styled-components@5.3.11_@babel+core@7.28.5_react-dom@18.3.1_react@18.3.1__react-is@18.3.1_react@18.3.1/node_modules/styled-components/dist/styled-components.browser.esm.js");const css_variables_namespaceObject=JSON.parse('{"yW":{"PQ":{"wH":"var(--charcoal-color-border-selected)"},"kL":{"Rm":{"Ay":"var(--charcoal-color-container-secondary-default)","PT":"var(--charcoal-color-container-secondary-hover)","c$":"var(--charcoal-color-container-secondary-press)"}},"Kk":{"Ay":"var(--charcoal-color-icon-default)","PT":"var(--charcoal-color-icon-hover)","c$":"var(--charcoal-color-icon-press)"},"Qq":{"Ay":"var(--charcoal-color-text-default)","PT":"var(--charcoal-color-text-hover)","c$":"var(--charcoal-color-text-press)","Rm":{"Ay":"var(--charcoal-color-text-secondary-default)"},"Xe":{"Ay":"var(--charcoal-color-text-tertiary-default)","PT":"var(--charcoal-color-text-tertiary-hover)","c$":"var(--charcoal-color-text-tertiary-press)"}}},"r8":{"m":"var(--charcoal-radius-m)","n":"var(--charcoal-radius-oval)"},"xe":{"Zp":{"10":"var(--charcoal-space-layout-10)","20":"var(--charcoal-space-layout-20)","30":"var(--charcoal-space-layout-30)"}},"Qq":{"J":{"rf":"var(--charcoal-text-font-size-body)","pG":{"m":"var(--charcoal-text-font-size-caption-m)","s":"var(--charcoal-text-font-size-caption-s)"},"R_":{"xs":"var(--charcoal-text-font-size-heading-xs)"}},"K_":{"rf":"var(--charcoal-text-line-height-body)","pG":{"m":"var(--charcoal-text-line-height-caption-m)","s":"var(--charcoal-text-line-height-caption-s)"},"R_":{"xs":"var(--charcoal-text-line-height-heading-xs)"}}}}');var dist=__webpack_require__("./packages/react/dist/index.js");const categories=["Illustration","Comic","Novel","3D","Shopping"],artworks=Array.from({length:3},((_,id)=>({id,title:"Title",thumbnail:`https://loremflickr.com/150/100/animals?random=${id}&lock=${id}`,description:"Description"})));function TokenV2Styled(){const[selected,setSelected]=(0,react.useState)(categories[0]);return(0,jsx_runtime.jsxs)(Container,{children:[(0,jsx_runtime.jsx)("nav",{children:(0,jsx_runtime.jsx)("div",{"aria-label":"Categories",role:"tablist",children:categories.map((category=>(0,jsx_runtime.jsx)(Tab,{id:`category-${category}`,role:"tab","aria-selected":category===selected,"aria-controls":`panel-${category}`,onClick:()=>{setSelected(category)},children:category},category)))})}),(0,jsx_runtime.jsx)(H2,{children:"Works from users you follow"}),(0,jsx_runtime.jsxs)(UserCard,{id:`panel-${selected}`,role:"tabpanel","aria-labelledby":`category-${selected}`,children:[(0,jsx_runtime.jsxs)(UserInfo,{children:[(0,jsx_runtime.jsx)(User,{"aria-label":"UserIcon",children:(0,jsx_runtime.jsx)(dist.In,{name:"24/FaceEdit"})}),(0,jsx_runtime.jsx)(UserName,{children:"UserName"}),(0,jsx_runtime.jsx)(dist.$n,{variant:"Primary",size:"S",children:"Follow"})]}),(0,jsx_runtime.jsx)(ShowAll,{children:"Show all"}),(0,jsx_runtime.jsx)(ArtworkList,{children:artworks.map((a=>(0,jsx_runtime.jsx)("li",{children:(0,jsx_runtime.jsxs)(Artwork,{children:[(0,jsx_runtime.jsx)(ArtworkThumbnail,{src:a.thumbnail,alt:a.title}),(0,jsx_runtime.jsx)(ArtworkTitle,{children:a.title}),(0,jsx_runtime.jsx)(ArtworkDescription,{children:a.description})]})},a.id)))},selected)]})]})}const Container=styled_components_browser_esm.Ay.section`
