...
`,Text="span",index_story={title:"react-sandbox/Pager",component:Pager,args:{page:5,pageCount:10}},Default={render:props=>(0,jsx_runtime.jsx)(Pager,{...props,children:"children"})};Default.parameters={...Default.parameters,docs:{...Default.parameters?.docs,source:{originalSource:"{\n  render: props => {\n    return <Pager {...props}>children</Pager>;\n  }\n}",...Default.parameters?.docs?.source}}}},"./packages/react-sandbox/src/foundation/utils.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{function unreachable(value){throw new Error(0===arguments.length?"unreachable":`unreachable (${JSON.stringify(value)})`)}__webpack_require__.d(__webpack_exports__,{H:()=>unreachable})}}]);
//# sourceMappingURL=react-sandbox-src-components-Pager-index-story.1cd4446d.iframe.bundle.js.map