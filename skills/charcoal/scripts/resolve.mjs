...
import {
  ...
  searchIconQuery,
  assertIconResult,
  assertIconSearchResult,
} from './lookup/icon.mjs'
...
const COMMANDS = new Set(['resolve', 'search', 'family', 'icon', 'search-icon'])
...
export function run(args) {
  ...
  else if (command === 'search-icon') assertIconSearchResult(result)
