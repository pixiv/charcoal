...
const SvgFillsquare = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (<svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" ref={ref} {...props}>
    ...
    <path d="M17 15.62a1.578 1.578 0 11-3.157 0c0-.872 1.579-2.96 1.579-2.96S17 14.748 17 15.62z" fill="currentColor"/>
    <path d="M3 17.25v-1.795l1.5 1.5v.295a2.25 2.25 0 002.25 2.25h10.5a2.25 2.25 0 002.25-2.25V6.75a2.25 2.25 0 00-2.25-2.25h-4.636l-1.5-1.5h6.136A3.75 3.75 0 0121 6.75v10.5A3.75 3.75 0 0117.25 21H6.75A3.75 3.75 0 013 17.25z" fill="currentColor"/>
  </svg>);
