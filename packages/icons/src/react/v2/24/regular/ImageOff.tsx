...
const SvgImageoff = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (<svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" ref={ref} {...props}>
    ...
    <path d="M18.572 13.805a2.748 2.748 0 00-2.336-.728L20.96 17.8c.026-.18.04-.364.04-.551V6.75A3.75 3.75 0 0017.25 3H6.75a3.78 3.78 0 00-.55.04L7.658 4.5h9.591a2.25 2.25 0 012.25 2.25v7.943l-.928-.888z" fill="#1F1F1F"/>
    <path fillRule="evenodd" clipRule="evenodd" d="M15.675 6.25a2.425 2.425 0 100 4.85 2.425 2.425 0 000-4.85zm-.925 2.425a.925.925 0 111.849 0 .925.925 0 01-1.849 0z" fill="#1F1F1F"/>
  </svg>);
