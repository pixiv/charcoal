...
const SvgLetterSpacing = (
  ...
  >
    ...
    />
    <path
      d="M10.002 8.82l-1.88 1.82a.5.5 0 000 .72l1.88 1.82a.5.5 0 00.848-.36v-1.07h2.3v1.07a.5.5 0 00.848.36l1.88-1.82a.5.5 0 000-.72l-1.88-1.82a.5.5 0 00-.848.36v1.07h-2.3V9.18a.5.5 0 00-.848-.36z"
      fill="currentColor"
    />
  </svg>
)
export const IconLetterSpacing: ReturnType<
