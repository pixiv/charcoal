...
const SvgCloudcheck = (
  ...
  >
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M18 23a5 5 0 100-10 5 5 0 000 10zm2.604-6.7a.5.5 0 010 .707l-3.247 3.246a.5.5 0 01-.707 0l-1.304-1.303a.5.5 0 11.707-.707l.95.95 2.893-2.893a.5.5 0 01.707 0z"
      fill="currentColor"
    />
  </svg>
)
export const IconCloudCheck: ReturnType<
