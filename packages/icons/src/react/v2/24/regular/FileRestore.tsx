...
const SvgFilerestore = (
  ...
  >
    ...
    />
    <path
      d="M14.776 13.501c.372 0 .675.302.675.675v.626a4.274 4.274 0 11-1.583 4.493.675.675 0 011.306-.336 2.925 2.925 0 005.756-.731 2.924 2.924 0 00-4.62-2.382h.797a.675.675 0 010 1.35h-2.331a.675.675 0 01-.675-.675v-2.345c0-.373.302-.675.675-.675z"
      fill="currentColor"
    />
  </svg>
)
export const IconFileRestore: ReturnType<
