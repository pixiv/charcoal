...
const SvgCharacterreplace = (
  ...
  >
    ...
    />
    <path
      d="M5.407 9.52L3.06 7.095A.645.645 0 013.522 6H8.22c.57 0 .86.684.463 1.094L6.335 9.52a.645.645 0 01-.928 0zM18.585 14.48l2.348 2.426A.645.645 0 0120.47 18h-4.698a.645.645 0 01-.463-1.094l2.348-2.427a.645.645 0 01.928 0z"
      fill="currentColor"
    />
  </svg>
)
