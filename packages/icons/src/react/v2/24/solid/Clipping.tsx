...
const SvgClipping = (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M13.257 9A2.742 2.742 0 0116 11.742v6.516A2.742 2.742 0 0113.258 21H6.742A2.743 2.743 0 014 18.258v-6.516A2.743 2.743 0 016.742 9h6.515zM10.5 12.667c0 1.012.821 1.833 1.833 1.833H14.5v-2.167c0-1.012-.82-1.833-1.833-1.833H10.5v2.167z"
      fill="currentColor"
    />
    <path
