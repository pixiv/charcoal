...
const SvgSelectimage = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (<svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" ref={ref} {...props}>
    ...
    <path fillRule="evenodd" clipRule="evenodd" d="M7.75 6A1.75 1.75 0 006 7.75v7.323l2.184-2.184a2.75 2.75 0 013.889 0l4.937 4.938A1.75 1.75 0 0018 16.25v-8.5A1.75 1.75 0 0016.25 6h-8.5zm8 4.002a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" fill="#1F1F1F"/>
    <path d="M15.063 18l-4.05-4.05a1.25 1.25 0 00-1.768 0l-3.068 3.068A1.75 1.75 0 007.75 18h7.313z" fill="#1F1F1F"/>
  </svg>);
